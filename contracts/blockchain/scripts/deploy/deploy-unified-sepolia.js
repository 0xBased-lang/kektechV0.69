...
/**
 * @title Unified Architecture Sepolia Deployment - Phase 4.3
 * @notice Deploys FlexibleMarketFactoryUnified with VersionedRegistry to Sepolia testnet
 * @dev Real network deployment for public validation before mainnet
 */

// Configuration
const CONFIG = {
    SAVE_FILE: path.join(__dirname, "../../sepolia-deployment-unified.json"),
    MIN_CREATOR_BOND: ethers.parseEther("0.1"), // 0.1 ETH minimum bond
    DISPUTE_WINDOW: 86400, // 24 hours
    MIN_DISPUTE_BOND: ethers.parseEther("0.01"), // 0.01 ETH
...
async function main() {
    ...
    console.log(`${colors.bright}${colors.magenta}║  KEKTECH 3.0 - UNIFIED SEPOLIA DEPLOYMENT (PHASE 4.3)  ║${colors.reset}`);
    ...
    try {
        ...
        await waitForConfirmations(registry);
        ...
        await waitForConfirmations(paramStorage);
        ...
        const marketConfig = {
            ...
            description: "Test market for Phase 4.3 unified deployment validation on Sepolia",
