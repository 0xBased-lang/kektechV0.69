...
describe("🔒 L-1 & L-3 Security Fixes - Fork Validation", function() {
    ...
    before(async function() {
        ...
        // Register contracts
        await registry.setContract(ethers.id("AccessControlManager"), await accessControl.getAddress());
        await registry.setContract(ethers.id("ParameterStorage"), await params.getAddress());
        await registry.setContract(ethers.id("FlexibleMarketFactory"), await factory.getAddress());
