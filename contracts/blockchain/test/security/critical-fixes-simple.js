...
describe("🔧 CRITICAL FIXES - SIMPLE VERIFICATION", function () {
    ...
    beforeEach(async function () {
        ...
        await masterRegistry.setContract(ethers.id("AccessControlManager"), await acm.getAddress());
        await masterRegistry.setContract(ethers.id("ParameterStorage"), await paramStorage.getAddress());
        ...
        await masterRegistry.setContract(ethers.id("ResolutionManager"), await resolutionManager.getAddress());
