 ...
 *
 * Purpose: Deploy complete KEKTECH 3.0 system to Sepolia for public testing
 ...
 *
 * Output: Deployment addresses for Etherscan verification
 */

async function main() {
    console.log("\n🚀 ========================================");
    console.log("🚀 KEKTECH 3.0 - SEPOLIA TESTNET DEPLOYMENT");
    console.log("🚀 ========================================\n");

    // Get signers
    const [deployer] = await ethers.getSigners();
    // On Sepolia, we only have 1 account from PRIVATE_KEY, so use deployer for all roles
    ...
    console.log("   Admin:", admin.address, "(same as deployer)");
    console.log("   Resolver:", resolver.address, "(same as deployer)");
    ...
    try {
        ...
        console.log("💾 Deployment data saved to: sepolia-deployment.json\n");
