...
describe("HIGH-002: Disputed Bond Handling", function() {
    async function deployFixture() {
        ...
        await registry.setContract(ethers.keccak256(ethers.toUtf8Bytes("AccessControlManager", 1, 1)), accessControl.target, 1);
        ...
        await registry.setContract(ethers.keccak256(ethers.toUtf8Bytes("ParameterStorage", 1, 1)), paramStorage.target, 1);
        ...
        await registry.setContract(ethers.keccak256(ethers.toUtf8Bytes("RewardDistributor", 1, 1)), rewardDist.target, 1);
        ...
        await registry.setContract(ethers.keccak256(ethers.toUtf8Bytes("MarketTemplateRegistry", 1, 1)), templateRegistry.target, 1);
        ...
        await registry.setContract(ethers.keccak256(ethers.toUtf8Bytes("FlexibleMarketFactory", 1, 1)), factory.target, 1);
